<script lang="ts">
  ...
  import * as yup from "yup";
    ...
    import { goto, ready, url } from "@roxi/routify";
  ...
  const makeRequest = () =>
    ...
    const { form, isValid, errors, handleChange, handleSubmit, isSubmitting } = createForm({
        initialValues: {
            email: "",
            password: "",
...
>
  ...
  >
    <div class="md:flex w-full">
      ...
      <form on:submit={handleSubmit} class="w-full md:w-1/2 py-10 px-5 md:px-10">
